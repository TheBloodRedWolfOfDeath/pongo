...
function modelLoaded() {
    console.log('PoseNet Is Initialized! Good luck!');
    console.log('I have aimbot! You will never win!!');
}
...
function move(){
  ...
  if (ball.y >= paddle1Y&& ball.y <= paddle1Y + paddle1Height) {
    ...
    console.log('HA! told you! Easy noob!')
    console.log('Get good.')
    console.log('does da wittle baby need more practice?')
    console.log('still, get better!')
  }
}
if(pcscore ==4){
    fill("#FFA500");
